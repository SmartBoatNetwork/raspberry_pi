...
if [ $MAXELEV -gt 19 ]
  then
    ...
    echo "/home/pi/weather/predict/weathersat_process.sh \"${1}\" $2 /home/pi/weather/${1//" "}${OUTDATE} /home/pi/weather/predict/weather.tle $var1 $TIMER" | at `date --date="TZ=\"UTC\" $START_TIME" +"%H:%M %D"`
